...
>
	...
	>
		...
		<div class="flex items-start gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800">
			...
			<span>
				Heurix adalah alat latihan ketahanan mental dan komunikasi, bukan penyedia bank soal atau
				bocoran pertanyaan dari instansi mana pun. Setiap sesi dirancang untuk melatih penguasaan
				diri, bukan menghafal jawaban.
			</span>
		</div>
